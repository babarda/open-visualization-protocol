...
<!-- Chart CH-TAB-01 STATUS MATRIX rendered in language DL-07 SAGA -->

## STATUS MATRIX chart, SAGA style
...
| row_label | `#111111` |
| status_word | `#2E2E2E` |
| status_complete | `#2E2E2E` |
| status_on_track | `#C0182B` |
| status_watch | `#B0B0B0` |
| status_critical | `#C0182B` |
| status_na | `#111111` |
| rule | `#111111` |
| title | `#111111` |
| source | `#2E2E2E` |
