...
<!-- Chart CH-TAB-01 STATUS MATRIX rendered in language DL-06 LEX -->

## STATUS MATRIX chart, LEX style
...
| row_label | `#1A1A1A` |
| status_word | `#333333` |
| status_complete | `#333333` |
| status_on_track | `#7A1F1F` |
| status_watch | `#B9B9B9` |
| status_critical | `#7A1F1F` |
| status_na | `#B9B9B9` |
| rule | `#B9B9B9` |
| title | `#1A1A1A` |
| source | `#333333` |
