...
<!-- Chart CH-TAB-01 STATUS MATRIX rendered in language DL-13 MIZAN -->

## STATUS MATRIX chart, MIZAN style
...
| row_label | `#31261D` |
| status_word | `#4E4237` |
| status_complete | `#3D5A46` |
| status_on_track | `#C4572E` |
| status_watch | `#C9BBA4` |
| status_critical | `#7A3B1E` |
| status_na | `#DCCFB6` |
| rule | `#DCCFB6` |
| title | `#31261D` |
| source | `#4E4237` |
